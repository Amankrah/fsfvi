...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-emerald-50 p-1 text-gray-600 border border-emerald-100",
      className
    )}
    {...props}
  />
