      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">FSFI Admin</h1>
            <p className="text-gray-600">Food Systems Financial Intelligence</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <p>FSFI System Administration Portal</p>
